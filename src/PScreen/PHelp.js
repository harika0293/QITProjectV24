  ...
  return (
    <Layout style={styles.container}>
      ...
      <Layout style={{marginTop: 40, marginHorizontal: 30}}>
        ...
        <Text style={styles.text}>
          We are constantly at the forefront of new technology and never settle
          for the minimal viable product.
        </Text>

        <Text style={styles.Heading}>Our Compassion: </Text>
        <Text style={styles.text}>
          We do our work with compassion. Keeping older adults safe, healthy,
          and in their own homes has special meaning to us and is what motivates
          us. Our hearts are in our work.
        </Text>
